...
InitialthetaUB = [1e3;1e6;1e8;1000;100000;1000;1000;1;10;10000];
Initialtheta = [500;5e5;5e7;500;500;500;500;0.02;1;450];

% plug into the wrapper function for the fitter
[xmin,fmin,counteval,stopflag,out] = ParameterFit(Initialtheta, InitialthetaLB, InitialthetaUB, Dataset,RunNumber,SaveNumber);
